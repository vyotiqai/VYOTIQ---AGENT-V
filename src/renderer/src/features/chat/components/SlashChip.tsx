...
export function SlashChip({
  ...
  return (
    <span
      className={cn(
        'inline-flex max-w-[12rem] items-center gap-1 px-0.5 text-[13px] leading-none text-violet-300',
        className
      )}
...
/** @deprecated Prefer `SlashChip` — kept for any leftover imports. */
export const SkillChip = SlashChip

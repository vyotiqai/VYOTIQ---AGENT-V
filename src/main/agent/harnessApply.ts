...
export function workspaceHarnessPath(workspacePath: string): string {
  return resolveInsideWorkspace(workspacePath, WORKSPACE_HARNESS_REL)
}
...
export async function applyHarnessProposal(
  ...
  writeFileSync(target, preview.proposed, 'utf8')

...
/** @deprecated Use gitignoreMatcherForDir during directory walks. */
export function loadGitignore(workspaceRoot: string): GitignoreMatcher {
  return gitignoreMatcherForDir(workspaceRoot, '')
}

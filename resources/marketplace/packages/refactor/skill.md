---
name: refactor
description: Use when restructuring code without changing intended behavior (cleanup, extract, rename, simplify).
version: 1.0.0
---
...
6. Leave unrelated code alone; do not drive-by cleanup adjacent files.
